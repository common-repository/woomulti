...
$templateData = array(
    ...
    'template_type' => 'word',// needs to be same name as template type folder (case sensitive)
    'templateID' => 'classic_word',// needs to be same name as template folder (case sensitive)
    'template_description' => '<strong>Classic</strong> is a clean proffesional word template with various colour options available and can be customised for each individual site.',
